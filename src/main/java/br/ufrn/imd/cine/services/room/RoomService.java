...
import br.ufrn.imd.cine.services.layout.ChildrensLayoutService;
...
public class RoomService extends GenericService<Room> {
	...
	@Autowired
	private ChildrensLayoutService layoutService;
	...
	public Room createRoom(@Valid CreateRoomRecord roomRecord) {
		...
		ChildrensLayout layout = layoutService.createLayout(roomRecord.seatingLayout());
