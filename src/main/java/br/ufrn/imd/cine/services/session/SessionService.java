...
import br.ufrn.imd.cine.services.ai.ChildrensAIService;
...
public class SessionService extends GenericService<Session> {
	...
	@Autowired
	private ChildrensAIService oaiService;
	...
	public List<Session> findSessionsRecommendated(User userLogged) throws Exception {
		List<Movie> moviesWatched = ticketRepository.findByParent(userLogged).stream()
